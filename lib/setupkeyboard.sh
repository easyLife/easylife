SetupKeyboard() {
	...
	sudo -u "$USERNAME" gsettings set org.gnome.desktop.peripherals.keyboard repeat-interval 30
	...
	sudo -u "$USERNAME" gsettings set org.gnome.desktop.peripherals.keyboard delay 250
