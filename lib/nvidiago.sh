NvidiaGo() {
	...
	dnf install -y --disableplugin=refresh-packagekit kernel-devel kernel-headers
	dnf update -y --disableplugin=refresh-packagekit kernel kernel-devel kernel-headers

	# $NVIDIAPKG is pulled from either nvidia.sh or nvidia304xx.sh or nvidia340xx.sh
	dnf install -y --disableplugin=refresh-packagekit --nogpgcheck "$NVIDIAPKG"
	dnf update -y --disableplugin=refresh-packagekit --nogpgcheck kmod-nvidia*
