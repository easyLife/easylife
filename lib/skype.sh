...
#	fi
	...
	yum install -y libXScrnSaver.i?86 libX11.i?86 libv4l.i?86     			\
		alsa-plugins-pulseaudio.i?86 qt-x11.i?86 glibc*686 libXScrnSaver*686    \
		libasound.so.2 libXv.so.1 libQtDBus.so.4 libQtGui.so.4
	...
	yum localinstall --nogpgcheck -y "$SKYPEPACKAGE"
